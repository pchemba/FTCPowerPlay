...
public class TestTeamElementWebcam extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        int cameraMonitorViewId = bot.getRobotHardware().getHwMap().appContext.getResources().getIdentifier("cameraMonitorViewId", "id", hardwareMap.appContext.getPackageName());
