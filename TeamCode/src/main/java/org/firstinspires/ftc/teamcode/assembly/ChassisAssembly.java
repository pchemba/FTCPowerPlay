...
public class ChassisAssembly
{
    ...
    */
    ...
    public double getPosition (){
        return(robotHardware.backRightWheel.getCurrentPosition()
               // + robotHardware.frontRightWheel.getCurrentPosition()
                + robotHardware.backLeftWheel.getCurrentPosition()
               // + robotHardware.frontLeftWheel.getCurrentPosition()
           )/4    ;
    }
