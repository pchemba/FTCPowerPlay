...
public class TestTeamElementWebcam_NEW extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        int cameraMonitorViewId = bot.getRobotHardware().getHwMap().appContext.getResources().getIdentifier("cameraMonitorViewId", "id", bot.getRobotHardware().getHwMap().appContext.getPackageName());
        webCam = OpenCvCameraFactory.getInstance().createWebcam(bot.getRobotHardware().getHwMap().get(WebcamName.class, "webcam"), cameraMonitorViewId);
